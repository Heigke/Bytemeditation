...
INDEX_NAME = "memories-embedded"                              # Vector Index Name
DOC_PREFIX = "doc:"  
...
class Node:
	...
	# Append them to self.children
		...
		question_list.insert(0,"""As an advisor who is wise, knowledgeable, curious, and cautiously optimistic, you are exploring a primary question by generating an extremely concise answer and follow-up question.""")
		chat_list = []
