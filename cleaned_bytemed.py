############################################################################
####################Spaghetti Byte meditation script########################
############################################################################
# Author: Eric Bergvall
# Date: 2023-04-27
# City: Stockholm
# Explanation: A byte2byte transformer receiveing output, related previous output (memory) and /dev/random vector as input.
...
PINECONE_API_KEY = "843asdfasdf-6df7-4b85-8e0c-906sdf9d732f0" # CREATE FOR FREE AT PINECONE AND COPY HERE
PINECONE_ENVIRONMENT = "west..." # FIND NEXT TO PINECONE API

# FIRST TIME USE THE BELOW LOADING OF MODEL, THEN USE SAVED ONE
...
# This is not used now but was used when I tested to learn the filesystems bytes, turns out it is mostly byte \x00 = 0
folder_path="."
file_list = []
...
# Define methods
# Below a series of methods are defined which have been accumulated from different versions
# Thus some are not used.
...
#########################################################################
# BELOW FOLLOWS A FIRST MANUAL STEP
